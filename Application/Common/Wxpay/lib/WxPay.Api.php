...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, 'D:\wwwroot\lben\wwwroot\Application\Common\Wxpay\cert\apiclient_cert.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, 'D:\wwwroot\lben\wwwroot\Application\Common\Wxpay\cert\apiclient_key.pem');
		}
		//post提交方式
