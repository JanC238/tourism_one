...
class JpushMerchantApi extends Model
{
    /***
     * 商家端
     ...
     * @return mixed
     */
    //tui('"' . $params['rid'] . '"', '您有新的订单', 1, 2, 'refresh,' . $params['uid']);
    ...
    public static function jpush($title, $message, $data, $titles,$messages=null)
    {
        ...
        $base64 = base64_encode("ec713847cd77fa8405e2e33f:a2ce127060bb044c785fe37e");
