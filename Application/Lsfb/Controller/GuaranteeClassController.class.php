...
Class GuaranteeClassController extends PublicController
{
    /**
     * @var \Lsfb\Model\GuaranteeClassModel
     */
    private $_model;
    ...
    public function add()
    {
        if (IS_POST) {
            ...
            $this->success('添加成功', U('/GuaranteeClass/index'));
        } else {
            $this->display('edit');
        }
    }
    ...
    public function edit($aid)
    {
        if (IS_POST) {
            ...
            $this->success('修改成功', U('/GuaranteeClass/index'));
        } else {
