...
class AboutUsScrollImgController extends PublicController
{
    /**
     * @var \Lsfb\Model\AboutUsScrollImgModel
     */
    private $_model;
    ...
    {
        $this->_model = D('AboutUsScrollImg');
    }
    ...
    public function add()
    {
        if (IS_POST) {
            ...
            $this->success('上传成功', U('/AboutUsScrollImg/index'));
        } else {
            $this->display('edit');
        }
    }
