					...
					<div class="row">
						<div class="pageheader" style="padding:0px 10px 10px 10px; border-bottom:0px; background:#FFF">
							<div style="border-bottom:1px #D8DBDB solid; padding:5px;font: 12px/1.5 Microsoft YaHei,Helvitica,Verdana,Arial,san-serif;">
								<?php if(ACTION_NAME == 'edit'): ?><h3 style="margin:0;">首页内容修改</h3>
									<?php else: ?>
									<h3 style="margin:0;">首页内容添加</h3><?php endif; ?>
						    </div>
						</div>
					</div>
							...
							<form class="Huiform" id="loginform" action="" method="post">
								...
								<table width="100%" class="tabled table-bordered m-top-md" border='0'>
									...
									<tr>
										<td>内容</td>
										<td>
											<textarea style="width: 200px" style="width: 200px" name="content_1" ><?php echo ($row["content_1"]); ?></textarea>
										</td>
									</tr>
									<tr>
										<td>内容</td>
										<td>
											<textarea style="width: 200px" name="content_2"  ><?php echo ($row["content_2"]); ?></textarea>
										</td>
									</tr>
									<tr>
										<td>内容</td>
										<td>
											<textarea style="width: 200px" name="content_3"  ><?php echo ($row["content_3"]); ?></textarea>
										</td>
									</tr>
									<tr>
										<th></th>
