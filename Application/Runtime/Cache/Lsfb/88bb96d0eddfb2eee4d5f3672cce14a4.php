					...
					<div class="row">
						<div class="pageheader" style="padding:0px 10px 10px 10px; border-bottom:0px; background:#FFF">
							<div style="border-bottom:1px #D8DBDB solid; padding:5px;font: 12px/1.5 Microsoft YaHei,Helvitica,Verdana,Arial,san-serif;">
								<?php if(ACTION_NAME == 'edit'): ?><h3 style="margin:0;">角色修改</h3>
									<?php else: ?>
									<h3 style="margin:0;">角色添加</h3><?php endif; ?>
						    </div>
						</div>
					</div>
							...
							<form class="Huiform" id="loginform" action="" method="post">
								...
								<table width="100%" class="tabled m-top-md" border='0'>
									...
									<tr>
										...
										<td><input name="name" type="text" class="form-control width200" value="<?php echo ($row["name"]); ?>" placeholder="角色名称" /></td>
									</tr>
									<tr>
										<td class="col-sm-1 col-xs-3">角色描述：</td>
										<td>
											<textarea name="bewrite"  class="form-control width200" placeholder="角色描述"><?php echo ($row["bewrite"]); ?></textarea>
										</td>
									</tr>
									<tr>
										<th></th>
