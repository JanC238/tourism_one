							...
							<form class="Huiform" id="loginform" action="" method="post">
								...
								<table width="100%" class="tabled table-bordered m-top-md" border='0'>
									...
									<tr>
										<td>标题一</td>
										<td>
											<input type="text" name="title_one" value="<?php echo ($row["title_one"]); ?>" class="form-control width200" placeholder="标题一">
										</td>
									</tr>
									<tr>
										<td>标题二</td>
										<td>
											<input type="text" name="title_two" value="<?php echo ($row["title_two"]); ?>" class="form-control width200" placeholder="标题二">
										</td>
									</tr>
									<tr>
										<td>内容</td>
