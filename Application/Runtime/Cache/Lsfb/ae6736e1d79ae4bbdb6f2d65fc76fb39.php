...
.btn.btn-info {
    ...
    <script src="/lsfb/tourism_one/Public/echart/echarts.min.js"></script>
    <style>
        .circle {
            padding: 20px;
            position: relative;
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        <div class="row">
                            <div class="col-sm-2">
                                <img src="/lsfb/tourism_one/Public/admin/main/admin.png" class="headerimg">
                            </div>
                            <div class="col-sm-4">
...
<script>
    ...
    $(function() {
        ...
        <script src="/lsfb/tourism_one/Public/lib/circle-progress.js"></script>
        <script>
