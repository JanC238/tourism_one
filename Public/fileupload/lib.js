    ...
    demo = new Vue({
        ...
        methods: {
            ...
            imgselect: function() {
                ...
                ajaxUpload({ img: files[uploadindex++] }, config.uploadpath, function(data) {
                    console.log('one', data)
                    self.uploadstate = false
                    self.img = data.img
                    self.imgs.push({ img: data.img, id: data.id, title: data.title })
            ...
            save: function() {
                ...
                if (this.state === 2) {
                    ...
                    config.save({ type: 1, img: this.imgs})
                }
                if (this.state === 3) {
                    var imgstr = []
