...
//                a.createBackgroundImage();
            ...
            createMarkup: function() {
                this.$wrapper = jQuery("<div class='html5zoo-wrapper-" + this.id + "'><div class='html5zoo-background-image-" + this.id + "'></div><div class='html5zoo-bottom-shadow-" + this.id + "'></div><div class='html5zoo-slider-" + this.id + "'><div class='html5zoo-box-" + this.id + "'><div class='html5zoo-swipe-box-" + this.id + "'><div class='html5zoo-space-" + this.id + "'></div><div class='html5zoo-img-box-" + this.id + "'></div></div></div><div style='z-index:4;' class='unslidertxtf html5zoo-text-wrapper-" + this.id + "'></div><div class='html5zoo-play-" + this.id + "'></div><div class='html5zoo-video-wrapper-" + this.id + "'></div><div class='html5zoo-ribbon-" + this.id + "'></div><div class='html5zoo-arrow-left-" + this.id + "'></div><div class='html5zoo-arrow-right-" + this.id + "'></div><div class='html5zoo-timer-" + this.id + "'></div><div class='html5zoo-watermark-" + this.id + "'></div></div><div style='z-index:5' class='dotsnew-nav html5zoo-nav-" + this.id + "'><div class='html5zoo-nav-container-" + this.id + "'></div></div></div>");
            ...
            showImage: function(g) {
                ...
                $(i).load(function() {
                 ...
                 //去宽高   var e = $("<div class='html5zoo-img-" + h.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:auto;'><img style='position:absolute;" + (ASPlatforms.isIE678() ? "opacity:inherit;filter:inherit;": "") + "width:" + b + "%;height:auto;left:" + (100 - b) / 2 + "%;top:0%;' src='" + h.elemArray[h.curElem][ELEM_SRC] + "' /></div>");
                    ...
                    var e = $("<div class='xunsliderimg show html5zoo-img-" + h.id + " ' style='z-index:3;display:block;position:absolute;left:0px;top:0px;'><img style='position:absolute;" + (ASPlatforms.isIE678() ? "opacity:inherit;filter:inherit;": "") + ";left:" + (100 - b) / 2 + "%;top:0%;' src='" + h.elemArray[h.curElem][ELEM_SRC] + "' /></div>");
                    var tempe = $("<div class='xunsliderimg show html5zoo-img-" + h.id + " ' style='z-index:1;display:block;position:absolute;left:0px;top:0px;'><img style='position:absolute;" + (ASPlatforms.isIE678() ? "opacity:inherit;filter:inherit;": "") + ";left:" + (100 - b) / 2 + "%;top:0%;' src='" + h.elemArray[h.curElem][ELEM_SRC] + "' /></div>");
...
//			if (curdifw < 0) $target.css({"margin-top": '0px'});
			else if (curdifw > 0) {
				$target.width(maxwidth).height('auto');
				curdifh = maxheight - $target.height();
