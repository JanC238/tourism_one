...
function wp_showdefaultHoverCss(layer_id)
{
	...
	$('#nav_'+layer_id+'').children('li').each(function(){
		...
		if(window.location.href == $(this).find("a").attr("href") || window.location.href == $(this).find("a").attr("href")+"&brd=1" || t_bool){ $(this).addClass("lihover").children('a').addClass("ahover"); }
		n++;
	});
